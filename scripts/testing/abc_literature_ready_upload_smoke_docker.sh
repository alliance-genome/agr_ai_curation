...
if [[ "${IS_ADD_LITERATURE_UPLOAD_SMOKE}" == "1" ]]; then
  AWS_PROFILE_NAME="${ADD_LITERATURE_UPLOAD_SMOKE_AWS_PROFILE:-${AWS_PROFILE_NAME:-${AWS_PROFILE:-default}}}"
else
  AWS_PROFILE_NAME="${ABC_LITERATURE_READY_UPLOAD_SMOKE_AWS_PROFILE:-${AWS_PROFILE_NAME:-${AWS_PROFILE:-default}}}"
fi
