...
run_check "domain-envelope-unit-path-validation" \
...
run_path_scoped_check \
  "abc-literature-ready-upload-smoke-docker-shell-regression-suite" \
  "bash scripts/tests/test_abc_literature_ready_upload_smoke_docker.sh" \
