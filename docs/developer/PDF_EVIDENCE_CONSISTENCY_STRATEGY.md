...
- run one `gpt-5.6-sol xhigh` architecture review on the plan before code changes
...
- run `gpt-5.6-sol xhigh` review on the slice
...
- run `gpt-5.6-sol xhigh` review on the completed route-parity slice
...
- run a `gpt-5.6-sol xhigh` review
