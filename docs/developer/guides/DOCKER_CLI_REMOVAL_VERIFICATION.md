...
packages/alliance/config/agent_studio_system_prompt.md:- **`get_docker_logs(container, lines)`** - System logs. Use only for failed calls or reported errors. Containers: backend, weaviate, postgres.
