...
| [COMPACT_VALIDATOR_DECISIONS.md](guides/COMPACT_VALIDATOR_DECISIONS.md) | Model-owned scientific decisions, runtime-owned source facts and canonical validator assembly |
