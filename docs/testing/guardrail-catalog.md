...
| G13 | Rendered Nginx PDF upload limit | The frontend image renders the shared PDF byte limit at startup and rejects malformed or non-positive configuration before Nginx starts. | ALL-728 | `scripts/testing/frontend_nginx_pdf_limit_contract.sh` |
