...
GENE_EXPRESSION_MULTI_FIXTURE_PACK_ID = "tmem67_multi_annotation_pending"
GENE_EXPRESSION_CURATOR_GUIDANCE_FIXTURE_PACK_ID = "curator_guidance_pending"
GENE_EXPRESSION_VALIDATOR_STATES = ("active", "under_development")
