    ...
    try:
        ...
        for obs in observations:
            ...
            if obs_type == 'GENERATION':
                ...
                for agent_pattern in ['supervisor', 'gene_expression', 'allele_variant_extraction', 'allele_extractor', 'ask_allele_extractor_', 'phenotype_extraction', 'phenotype_specialist', 'ask_phenotype_', 'pdf_specialist', 'gene', 'allele',
...
- **`get_prompt(agent_id, mod_id)`** - Fetch exact agent prompts.
  - agent_id: supervisor, pdf, gene, allele, allele_extractor, disease, chemical, gene_ontology, go_annotations, orthologs, gene_expression, phenotype, ontology_mapping, chat_output, csv_formatter, tsv_formatter, json_formatter
