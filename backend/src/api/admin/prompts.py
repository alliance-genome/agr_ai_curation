...
class CreatePromptRequest(BaseModel):
    ...
    agent_name: str = Field(..., min_length=1, max_length=100, description="Agent ID from catalog (e.g., 'pdf_extraction', 'gene_validation')")
...
async def list_prompts(
    ...
    Args:
        agent_name: Filter by agent name (e.g., 'pdf_extraction', 'gene_validation')
...
async def get_prompt_history(
    ...
    Args:
        agent_name: Agent ID from catalog (e.g., 'pdf_extraction', 'gene_validation')
