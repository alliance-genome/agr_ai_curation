...
async def _run_agent_with_owned_resources(
    ...
    try:
        ...
        # Run-state package tools (stage/finalize) otherwise execute in the package
        # subprocess, where this run's workspace does not exist; every builder agent
        # run directly needs it bound, not only profiles.
