"""Legacy backend copy of Alliance lookup projection and detail-fetch helpers.

New Alliance lookup behavior belongs in the package-owned copy under
packages/alliance/python/src/agr_ai_curation_alliance/tools/agr_lookup.py.
This module only preserves the frozen backend compatibility surface until the
legacy backend AGR curation tool is removed.
"""
