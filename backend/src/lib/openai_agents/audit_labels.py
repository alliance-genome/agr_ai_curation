...
INTERNAL_TOOL_DISPLAY_NAMES: Dict[str, str] = {
    ...
    "list_recorded_evidence": "List Recorded Evidence",
    "get_recorded_evidence": "Get Recorded Evidence",
    "attach_evidence_to_object": "Attach Evidence To Object",
    "detach_evidence_from_object": "Detach Evidence From Object",
    "discard_recorded_evidence": "Discard Recorded Evidence",
    "update_recorded_evidence_metadata": "Update Evidence Metadata",
    "sql_query": "SQL Query",
