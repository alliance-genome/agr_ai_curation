...
# ============================================================================
# Allele Extraction Structured Output Models
# ============================================================================

class AlleleExtractionFinding(BaseModel):
    """A single retained allele/variant assertion."""
    mention: str = Field(
        ...,
        description="Allele/variant notation exactly as written in the paper"
    )
    normalized_symbol: Optional[str] = Field(
        None,
        description="Normalized allele/variant symbol when resolved"
    )
    normalized_id: Optional[str] = Field(
        None,
        description="Database identifier when resolved (e.g., WB:WBVar...)"
    )
    associated_gene: Optional[str] = Field(
        None,
        description="Associated gene symbol/ID if supported by evidence"
    )
    confidence: Literal["high", "medium", "low"] = Field(
        "medium",
...
# ============================================================================
# Disease Extraction Structured Output Models
# ============================================================================

class DiseaseExtractionFinding(BaseModel):
    """A single retained disease assertion."""
    mention: str = Field(
        ...,
        description="Disease mention exactly as written in the paper"
    )
    normalized_label: Optional[str] = Field(
        None,
        description="Normalized disease label when resolved"
    )
    normalized_id: Optional[str] = Field(
        None,
        description="Normalized ontology identifier when resolved (DOID/MONDO)"
    )
    role: Literal["primary", "background", "comparative", "model_context", "unspecified"] = Field(
        "unspecified",
        description="Disease mention role within paper context"
    )
    confidence: Literal["high", "medium", "low"] = Field(
        "medium",
...
class GeneExtractionFinding(BaseModel):
    """A single retained gene assertion."""
    mention: str = Field(
        ...,
    ...
    normalized_symbol: Optional[str] = Field(
        None,
        description="Normalized gene symbol when resolved"
    )
    normalized_id: Optional[str] = Field(
        None,
        description="Database identifier when resolved (e.g., WB:WBGene...)"
    )
    species: Optional[str] = Field(
        None,
        description="Species/taxon context when explicitly supported"
    )
    confidence: Literal["high", "medium", "low"] = Field(
        "medium",
        description="Extractor confidence in normalization and classification"
