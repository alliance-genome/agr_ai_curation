...
BATCHING_NUDGE_CONFIG = {
    ...
    "ask_ontology_term_specialist": {
        "example": 'ask_ontology_term_specialist("Resolve these typed ontology terms: anatomy pharynx for WB, life stage L3 larval stage for WB, GO cellular component nucleus, ...")',
        "entity": "terms",
    },
