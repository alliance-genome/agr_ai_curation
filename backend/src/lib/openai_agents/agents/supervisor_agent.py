...
def create_supervisor_agent(
    ...
    @function_tool(
        ...
        description_override=(
            ...
            "is marked withheld; read it exactly with detail=\"message\", its "
            "message_id and content_cursor, following next_content_cursor until "
            "complete. Use this when earlier turns may have been "
