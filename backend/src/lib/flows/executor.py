...
from src.lib.flows.persisted_flow_migrations import validate_persisted_flow_definition
...
def _count_agent_ids(flow: CurationFlow) -> Dict[str, int]:
    ...
    per step (e.g., ask_gene_validation_step1_specialist,
    ask_gene_validation_step3_specialist).
...
async def execute_flow(
    ...
    """
    validate_persisted_flow_definition(flow.flow_definition or {})
    logger.info(
