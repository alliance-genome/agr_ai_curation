...
def test_convergence_runs_only_the_missing_parent_branch(start, expected):
    ...
    assert upgrade == expected | {"8c4279ba51ef", "q4f5a6b7c8d9", "r5a6b7c8d9e0", "s6t7u8v9w0x1", "92a22b250925", "a31c05e0925a", "b42c05e0925b", "c53c05e0925c", "d64c05e0925d"}
...
def test_alembic_script_directory_resolves_exactly_one_head():
    ...
    assert script.get_heads() == ["d64c05e0925d"]
