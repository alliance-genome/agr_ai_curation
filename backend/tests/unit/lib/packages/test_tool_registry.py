...
def test_repo_shipped_tool_bindings_are_loaded_from_alliance_package():
    ...
    expected_bindings = {
        "get_agent_contract": ("static", (), "agr.alliance"),
        ...
        "read_chunk": ("context_factory", ("document_id", "user_id"), "agr.alliance"),
        ...
        "list_recorded_evidence": ("context_factory", ("document_id", "user_id"), "agr.alliance"),
        "get_recorded_evidence": ("context_factory", ("document_id", "user_id"), "agr.alliance"),
        "attach_evidence_to_object": ("context_factory", ("document_id", "user_id"), "agr.alliance"),
        "detach_evidence_from_object": ("context_factory", ("document_id", "user_id"), "agr.alliance"),
        "discard_recorded_evidence": ("context_factory", ("document_id", "user_id"), "agr.alliance"),
        "update_recorded_evidence_metadata": ("context_factory", ("document_id", "user_id"), "agr.alliance"),
