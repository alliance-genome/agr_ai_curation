...
ALLOWED_ALLIANCE_TEST_PATHS = {
    ...
    Path("backend/tests/unit/test_rgd_go_paper_curator_prompt_policy.py"),
    ...
    Path("backend/tests/unit/api/test_curation_workspace_api.py"),
    ...
    Path("backend/tests/unit/lib/curation_workspace/test_pipeline.py"),
    ...
    Path("backend/tests/contract/alliance/tools/test_gene_product_resolution_live.py"),
    ...
    Path("backend/tests/integration/persistence/test_domain_envelope_persistence.py"),
