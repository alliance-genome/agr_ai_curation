"""Upsert disease_extractor system agent into unified agents table.
...
def _load_agent_spec() -> Tuple[Dict[str, Any], str]:
    ...
    spec = {
        ...
        "name": str(agent_data.get("name") or "Disease Extraction Agent"),
    ...
    connection.execute(
        sa.text(
            ...
            VALUES (
                ...
                true,
                :created_by,
                'Seeded disease_extractor prompt for unified agents runtime parity',
                :source_file
            )
            """
        ),
