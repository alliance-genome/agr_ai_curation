"""Upsert allele_extractor system agent into unified agents table.
...
_AGENT_KEY = "allele_extractor"
_AGENT_ID = "allele_variant_extraction"
_CREATED_BY = "alembic:d5e6f7a8b9c0"
...
def _load_agent_spec() -> Tuple[Dict[str, Any], str]:
    ...
    spec = {
        ...
        "name": str(agent_data.get("name") or "Allele/Variant Extraction Agent"),
    ...
    connection.execute(
        sa.text(
            ...
            VALUES (
                ...
                true,
                :created_by,
                'Seeded allele_extractor prompt for unified agents runtime parity',
                :source_file
            )
            """
        ),
