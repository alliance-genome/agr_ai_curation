"""Upsert chemical_extractor system agent into unified agents table.
...
_AGENT_ID = "chemical_extraction"
_CREATED_BY = "alembic:f7a8b9c0d1e2"
...
def _load_agent_spec() -> Tuple[Dict[str, Any], str]:
    ...
    spec = {
        ...
        "name": str(agent_data.get("name") or "Chemical Extraction Agent"),
    ...
    connection.execute(
        sa.text(
            ...
            VALUES (
                ...
                true,
                :created_by,
                'Seeded chemical_extractor prompt for unified agents runtime parity',
                :source_file
            )
            """
        ),
