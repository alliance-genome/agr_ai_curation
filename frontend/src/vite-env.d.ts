...
interface ImportMetaEnv {
  ...
  readonly VITE_RUN_COMPLETION_TOAST_AUTO_HIDE_MS: string;
  ...
  readonly VITE_ADD_LITERATURE_MAX_SELECTED_FILES: string;
  readonly VITE_ADD_LITERATURE_PDF_JOB_WINDOW_DAYS: string;
  readonly VITE_ADD_LITERATURE_PDF_JOB_LIMIT: string;
  readonly VITE_ADD_LITERATURE_FALLBACK_POLL_INTERVAL_MS: string;
}
