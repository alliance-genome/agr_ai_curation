...
export const PDF_PROGRESS_CONNECT_TIMEOUT_MS = positiveEnvInt('VITE_PDF_PROGRESS_CONNECT_TIMEOUT_MS', 5000);
export const PDF_PROGRESS_TIMEOUT_MS = positiveEnvInt('VITE_PDF_PROGRESS_TIMEOUT_MS', 3600000);
export const PDF_PROGRESS_POLL_INTERVAL_MS = positiveEnvInt('VITE_PDF_PROGRESS_POLL_INTERVAL_MS', 1000);
