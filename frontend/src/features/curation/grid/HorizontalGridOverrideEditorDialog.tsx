  ...
  return (
    ...
    >
      <Box sx={{ p: '20px 20px 0' }}>
        <Stack direction="row" spacing="12px" sx={{ alignItems: 'flex-start', justifyContent: 'space-between' }}>
          <Box>
            <Typography
              sx={{ color: 'text.secondary', display: 'block', fontSize: 9, fontWeight: 770, letterSpacing: '0.08em', mb: '3px', textTransform: 'uppercase' }}
            >
              Curator override
            </Typography>
