...
export default function WorkshopStartScreen({ onChoose, onCustomExtraction, agents = {}, hasTemplates, hasSavedAgents }: WorkshopStartScreenProps) {
  ...
  const choices: Choice[] = [
    ...
    {
      mode: 'clone',
      help: 'Copy one of your agents or a project-shared agent into a separate private agent. Changes to the copy do not change the original agent or flows that use it.',
