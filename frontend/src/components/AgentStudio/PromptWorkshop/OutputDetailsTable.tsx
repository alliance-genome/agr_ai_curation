...
export default function OutputDetailsTable({ value, issues = [], disabled = false, onEdit, onInfo }: {
  ...
  return (
      ...
      <Table aria-label="Details to collect" sx={{ minWidth: 560 }}>
        ...
        {rows.length === 0 && <TableRow><TableCell colSpan={onEdit ? 5 : 4} sx={{ py: 5, textAlign: 'center' }}><Typography fontWeight={600}>No details yet</Typography><Typography color="text.secondary" sx={{ mt: 1 }}>Add your first detail, such as “Stock name”.</Typography></TableCell></TableRow>}
        </TableBody>
