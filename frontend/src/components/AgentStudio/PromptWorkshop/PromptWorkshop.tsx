...
const MODEL_HELP_TEXT = [
  ...
  '• gpt-5.2 (medium reasoning): default for complex PDF extraction and hard reasoning.',
  '• gpt-5.2-mini: balanced speed and quality for iterative drafting.',
].join('\n')
