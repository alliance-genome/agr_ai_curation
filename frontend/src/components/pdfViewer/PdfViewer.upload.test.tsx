...
describe('PdfViewer drag-and-drop upload', () => {
  ...
  it('toggles drop-zone affordance while dragging', () => {
    ...
    expect(screen.getByText(/For one or multiple uploads, open/i)).toBeInTheDocument()
    expect(screen.getByText(/click the green file icon in that row\./i)).toBeInTheDocument()
